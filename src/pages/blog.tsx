  ...
  return (
    <>
      <div className="flex flex-col h-screen">
        <Header></Header>
        <main className="flex flex-col w-screen max-w-3xl mx-auto my-8 mb-auto">
          <h1 className="text-2xl font-railway">Recent Posts</h1>
          <ol className="relative border-l border-gray-200 max-w-3xl mx-4 my-8">
